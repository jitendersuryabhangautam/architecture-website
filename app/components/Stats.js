  ...
  return (
    <div className=" bg-white my-12 ">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-0 shadow-lg rounded-lg">
          {stats.map((stat, index) => (
            <div key={index} className="text-center p-16 relative">
              ...
              <div className="text-gray-800 text-lg font-medium uppercase tracking-wide leading-tight">
                {stat.label}
              </div>
            </div>
          ))}

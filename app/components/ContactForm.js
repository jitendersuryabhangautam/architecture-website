      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div>
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-5xl font-bold mb-4 text-gray-900 flex gap-3 items-end">
                Let&apos;s Build Your
                <span
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        652p, 64-65, Dividing Rd, Sector 65,
                        <br />
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:harkesh.gautam8685@gmail.com"
                        className="text-gray-600 hover:text-[#AD8151] transition-colors text-lg font-medium"
                      >
                        harkesh.gautam8685@gmail.com
                      </a>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        {/* Instagram */}
                        <a
                          href="https://www.instagram.com/studio.steponedesign/"
                          target="_blank"
                        ...
                        >
                          <div
                            ...
                            style={{
                              background:
                                "linear-gradient(135deg, rgba(173, 129, 81, 0.08), rgba(212, 167, 106, 0.08))",
                          ...
                          <span className="text-gray-600 hover:text-[#AD8151] transition-colors text-base font-medium">
                            @studio.steponedesign
                          </span>
                        </a>
                        ...
                        {/* LinkedIn
                           ...
                           <a
                          href="https://linkedin.com/company/step-one-studio"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center gap-3 group hover:translate-x-1 transition-transform duration-300"
                        >
                        ...
                        {/* Facebook
                          ...
                          <a
                          href="https://facebook.com/steponestudio"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center gap-3 group hover:translate-x-1 transition-transform duration-300"
                        >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-5 py-3 rounded-xl border transition-all duration-300 focus:outline-none focus:border-[#AD8151] focus:ring-2 focus:ring-[#AD8151] focus:ring-opacity-20"
                        style={{
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        rows="5"
                        className="w-full px-5 py-3 rounded-xl border transition-all duration-300 focus:outline-none focus:border-[#AD8151] focus:ring-2 focus:ring-[#AD8151] focus:ring-opacity-20 resize-none"
                        style={{
                          background: "rgba(255, 255, 255, 0.9)",
                          borderColor: "rgba(173, 129, 81, 0.2)",
                        }}
